...
class UpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'suppl_prim_img' => 'bail|nullable|file',
            'suppl_sec_img' => 'bail|nullable|file',
    ...
    public function messages(): array
    {
        return [
            ...
            'main_img.required' => 'Main image is mandatory',
            'main_img.file' => 'Main image must be a file',
            'suppl_prim_img.required' => 'Supplementary primary image is mandatory',
            'suppl_prim_img.file' => 'Supplementary primary image must be a file',
            'suppl_sec_img.required' => 'Supplementary secondary image is mandatory',
            'suppl_sec_img.file' => 'Supplementary secondary image must be a file',
